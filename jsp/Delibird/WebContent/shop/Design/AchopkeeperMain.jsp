						...
						<div class="inner">
							...
							<!-- Banner -->
								<section id="banner">
									<div class="content">
										<header>
											<h1>안녕하세요 Delibird 입니다.<br />
											Delibird 의 점주 홈페이지 입니다.</h1>
									...
									<span class="image object">
										...
										<img src="./Design/resource/images/rogo.jpg" alt="" /> <!-- 로고 그려서 넣을거 -->
									</span>
								</section>
							...
							<!-- Menu -->
								<nav id="menu">
									...
									<ul>
										...
										<li>
												<a href="ReceptionCheck.jsp">주문 </a> 
									
										</li>
										
								
										<li><a href="Menumanagement.jsp">메뉴 관리</a></li>
								...
								<section>
									...
									<ul class="contact">
										<li class="icon solid fa-envelope"><a href="#">ssr0128@bc.ac.kr</a></li>
										<li class="icon solid fa-phone">(032) 610-8650</li>
										<li class="icon solid fa-home">경기 부천시 소사로 56 부천대학교  공학강의동 5층 <br />
										</li>
									</ul>
								</section>
